...
for run in range(1, 4):
    ...
    trainer.fine_tune(f'resources/taggers/conll_eng_dutch_ner_roberta_large_run_{run}_linear_probing_lr{lr}',
                      learning_rate=0.3,
                      mini_batch_size=32,
                      )
    del tagger
    ...
    finished_tagger = SequenceTagger.load(f'resources/taggers/conll_eng_dutch_ner_roberta_large_run_{run}_linear_probing_lr{lr}/final-model.pt')
    ...
    new_trainer.fine_tune(f'resources/taggers/conll_eng_dutch_ner_roberta_large_run_{run}_full_fine_tuning_BitFit_lr{lr}',
